...
f0 = readtable([model, '/angular_error_fold0.csv'], 'Delimiter', ',');
f1 = readtable([model, '/angular_error_fold1.csv'], 'Delimiter', ',');
f2 = readtable([model, '/angular_error_fold2.csv'], 'Delimiter', ',');
